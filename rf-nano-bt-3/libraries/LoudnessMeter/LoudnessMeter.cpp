...
LoudnessMeter::LoudnessMeter(uint8_t micOut, uint8_t micGain, uint8_t micSampleWindow, uint16_t defaultPeakToPeakLow, uint16_t defaultPeakToPeakHigh, uint16_t defaultRmsLow, uint16_t defaultRmsHigh) {
    this->micOut = micOut;
